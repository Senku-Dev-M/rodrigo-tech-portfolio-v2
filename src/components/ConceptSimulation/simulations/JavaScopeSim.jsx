...
export default function JavaScopeSim() {
    ...
    return (
        ...
        >
            <h3 style={{ color: '#00d4ff', marginBottom: '0.5rem' }}>Ambito de variable (scope)</h3>
            <p
                style={{
                    color: 'var(--text-grey)',
                    marginBottom: '1.4rem',
                ...
                >
                    <motion.div
                        ...
                        animate={{
                            ...
                            borderLeft: activeBlock === 'main' ? '4px solid #67e8f9' : '4px solid transparent',
                        }}
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                margin: '0.45rem 0',
                                cursor: 'pointer',
                                background: hoverVar === 'global' ? 'rgba(0, 212, 255, 0.2)' : 'transparent',
                                borderRadius: '4px',
                                borderLeft: hoverVar === 'global' ? '2px solid #00d4ff' : '2px solid transparent',
                            }}
                        >
                        ...
                        >
                            ...
                            <div style={{ color: '#67e8f9' }}>{'}'} <span style={{ color: '#5c6370', fontSize: '0.82em' }}>// temporal muere aqui</span></div>
                        </motion.div>
                        ...
                        <div style={{ color: '#67e8f9' }}>{'}'} <span style={{ color: '#5c6370', fontSize: '0.82em' }}>// numero muere aqui</span></div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        animate={{
                            background: activeBlock === 'method' ? 'rgba(56, 189, 248, 0.1)' : 'transparent',
                            borderLeft: activeBlock === 'method' ? '4px solid #38bdf8' : '4px solid transparent',
                        }}
                        style={{
                            padding: '0.5rem',
                            borderRadius: '0 6px 6px 0',
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                margin: '0.45rem 0',
                                cursor: 'pointer',
                                background: hoverVar === 'external' ? 'rgba(56, 189, 248, 0.2)' : 'transparent',
                                borderRadius: '4px',
                                borderLeft: hoverVar === 'external' ? '2px solid #38bdf8' : '2px solid transparent',
                            }}
                        >
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...
                                fontWeight: 'bold',
                                color: activeBlock === 'main' ? '#67e8f9' : activeBlock === 'if' ? '#27ae60' : '#38bdf8',
                                marginTop: '0.45rem',
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <p style={{ margin: 0, fontSize: isCompact ? '0.84rem' : '0.9rem', color: '#e5e7eb', lineHeight: 1.6 }}>
                                        La variable <strong style={{ color: hoverVar === 'global' ? '#00d4ff' : hoverVar === 'local' ? '#27ae60' : '#38bdf8' }}>{activeVar.name}</strong>{' '}
